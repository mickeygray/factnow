   ...
   <div className='grid-2'>
    <div className='card'>
     ...
     <p>
      ...
      notice for amounts that I knew I could never pay. It felt hopeless Act Now
      took action they called the IRS right away and started the process to and
      helped me in my time of need. I couldn’t thank them enough for the
    ...
    <div className='card'>
     ...
     <p>
      ...
      Offer, they just wanted my money. I called Act Now and spoke with Ted, he
      was the complete opposite of everyone else. What a relief, he really knew
      his stuff. He explained that I should have been making estimated payments
      along with a few other things in order for the Offer to get accepted. I
      hired them on the spot and 6 months later the IRS accepted an offer of
      $4,300. I really couldn’t believe it, my business is back on track and
      paying my current taxes. I don’t know where I would be without them, 5
    ...
    <div className='card'>
     ...
     <p>
      ...
      overwhelming and I wasn’t sure whom to turn to until I called Act Now. I
      spoke with Ted and right away he put my mind at ease. He explained that
    ...
    <div className='card'>
     ...
     <h5>Act Now Will Fight For You</h5>
     <p>
      ...
      called Act Now and spoke with Ted. He quickly evaluated my situation and
      pointed out that the IRS had the wrong information and my tax liability
      was not accurate. I thought I owed it because that’s what the IRS was
      saying and I just believed them. Act Now resolved the problem, educated me
      on how to operate efficiently and now I’m current with all my taxes.
     </p>
    </div>
   </div>
  </div>
